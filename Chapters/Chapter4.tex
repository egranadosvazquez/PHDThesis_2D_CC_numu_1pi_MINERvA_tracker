...
\begin{figure}
    \centering
    \includegraphics[scale=0.3]{Figures/Chapter4/BGStudies/Bd_Background_wexp_WSB.png}
    \includegraphics[scale=0.3]{Figures/Chapter4/BGStudies/Bd_Background_mixtpi_Int.png}
